...
byte A6lib::blockUntilReady(long baudRate) {
  ...
  logln("in block start Waiting for module to be ready...");
    ...
    // Profile write. - SHS - MAY BE ADD NEXT LINE -
    // A6command("AT&W", "OK", "yy", A6_CMD_TIMEOUT, 2, NULL);
...
byte A6lib::begin(long baudRate) {
    ...
    // User profile set. - SHS - MAY BE ADD NEXT LINE -
    // A6command("ATZ", "OK", "yy", A6_CMD_TIMEOUT, 2, NULL);
    ...
    // - SHS - MAY BE REMOVE NEXT COMMAND -
...
//    }
    ...
    // Set SMS character set. "UCS2" "GSM"
    setSMScharset("GSM");
